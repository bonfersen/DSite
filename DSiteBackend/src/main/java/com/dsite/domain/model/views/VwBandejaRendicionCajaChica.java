...
public class VwBandejaRendicionCajaChica implements Serializable {
	...
	private String codigoRendicionCaja;
	private String codigoRendicionViatico;
	...
	public String getCodigoRendicionCaja() {
		return codigoRendicionCaja;
	}

	public void setCodigoRendicionCaja(String codigoRendicionCaja) {
		this.codigoRendicionCaja = codigoRendicionCaja;
	}

	public String getCodigoRendicionViatico() {
		return codigoRendicionViatico;
	}

	public void setCodigoRendicionViatico(String codigoRendicionViatico) {
		this.codigoRendicionViatico = codigoRendicionViatico;
	}
}
